<template>
  <div class="mb-4 container">
    ...
    <div v-else>
      <div class="row">
        <div v-for="integration in integrationsByType" :key="integration.id" class="col-md-3">
          <div class="card m-2">
            <div class="card-header">
              <span>
                <img :src="integrationIcons[integration.type] ||
      integrationIcons.default
      " :alt="integration.type" width="20" height="20" class="align-middle" />
                {{
